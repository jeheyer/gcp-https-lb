...
| Name      | Description                                           | Type   | Default |
|-----------|-------------------------------------------------------|--------|---------|
| use_ipv4  | Use IPv4 for the Listener Address (forwarding rule)   | `bool` | true    |
| use_ipv6  | Use IPv6 for the Listener Address (forwarding rule)   | `bool` | false   |

#### Notes

- `use_ipv6` is only supported on external global Load Balancers
